...
OUTPUT = ROOT / "deploy" / "hf_space_bundle"
...
FILES = [
    ...
    "Food_Vision_Model/checkpoint-2400/model.safetensors",
    "Food_Vision_Model/checkpoint-2400/preprocessor_config.json",
]
SKIP_DIR_NAMES = {"generated", "__pycache__"}
...
def main() -> int:
    ...
    print(f"Created Hugging Face Space bundle at {OUTPUT}")
    return 0
